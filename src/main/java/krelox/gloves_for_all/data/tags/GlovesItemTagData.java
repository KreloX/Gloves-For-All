...
public class GlovesItemTagData extends ItemTagsProvider {
    ...
    public void addTags(HolderLookup.Provider provider) {
        ...
        // Voidscape
        tag(GlovesTags.Items.GEMS_VOIDIC_CRYSTAL).add(ModItems.VOIDIC_CRYSTAL.get());
        tag(GlovesTags.Items.GEMS_TITANITE).add(ModItems.TITANITE_SHARD.get());
        tag(GlovesTags.Items.GEMS_ICHOR).add(ModItems.ICHOR_CRYSTAL.get());
        tag(GlovesTags.Items.GEMS_ASTRAL).add(ModItems.ASTRAL_CRYSTAL.get());
    }
}
