...
public class GlovesLootModifierData extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        for (var item : lootGloves) {
            ...
            add(compatMaterial.getCompatModule().getSourceModId() + "/gloves_loot_" + compatMaterial.getName(), new CompatGlovesLootModifier(new LootItemCondition[]{}, new ItemStack(gloves), compatMaterial));
        }
    }
}
