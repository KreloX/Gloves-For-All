...
public class GlovesItems {
    ...
    // Savage & Ravage
    public static final RegistryObject<Item> GRIEFER_GLOVES = registerGloves(GRIEFER, () -> new GrieferGlovesItem(GRIEFER, 0.5, new Item.Properties()));
    // Oreganized
    ...
    // Voidscape
    public static final RegistryObject<Item> VOIDIC_CRYSTAL_GLOVES = registerGloves(VOIDIC_CRYSTAL, () -> new VoidscapeGlovesItem(VOIDIC_CRYSTAL, 1.25, 0.1, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> CORRUPT_GLOVES = registerGloves(CORRUPT, () -> new VoidscapeGlovesItem(CORRUPT, 1.35, 0.2, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> TITANITE_GLOVES = registerGloves(TITANITE, () -> new VoidscapeGlovesItem(TITANITE, 1.5, 0.3, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> ICHOR_GLOVES = registerGloves(ICHOR, () -> new VoidscapeGlovesItem(ICHOR, 1.6, 0.4, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> ASTRAL_GLOVES = registerGloves(ASTRAL, () -> new VoidscapeGlovesItem(ASTRAL, 1.75, 0.5, new Item.Properties().fireResistant()));
    // Midnight
    ...
    // Botania
    public static final RegistryObject<Item> MANASTEEL_GLOVES = registerGloves(MANASTEEL, () -> new ManasteelGlovesItem(MANASTEEL, 0.5, () -> BotaniaItems.manasteelBoots, new Item.Properties()));
    public static final RegistryObject<Item> ELEMENTIUM_GLOVES = registerGloves(ELEMENTIUM, () -> new ElementiumGlovesItem(ELEMENTIUM, 0.5, () -> BotaniaItems.elementiumBoots, new Item.Properties()));
    public static final RegistryObject<Item> MANAWEAVE_GLOVES = registerGloves(MANAWEAVE, () -> new ManasteelGlovesItem(MANAWEAVE, 0.25, () -> BotaniaItems.manaweaveBoots, new Item.Properties()));
    public static final RegistryObject<Item> TERRASTEEL_GLOVES = registerGloves(TERRASTEEL, () -> new ManasteelGlovesItem(TERRASTEEL, 1.0, () -> BotaniaItems.terrasteelBoots, new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> FLUX_INFUSED_GLOVES = registerGloves(FLUX, () -> CompatModule.REDSTONE_ARSENAL.isLoaded()
            ? new FluxGlovesItem(FLUX, 0.85, 800000, 10000, new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON).setNoRepair())
            : new CompatGlovesItem(FLUX, 0.85, new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON).setNoRepair()));
    // Thermal Core
    public static final RegistryObject<Item> BEEKEEPER_GLOVES = registerGloves(BEEKEEPER, () -> new TooltipGlovesItem(BEEKEEPER, 0.25, Suppliers.memoize(() -> ThermalCore.ITEMS.get(ThermalIDs.ID_BEEKEEPER_BOOTS)), new Item.Properties()));
    public static final RegistryObject<Item> DIVING_GLOVES = registerGloves(DIVING, () -> new DivingGlovesItem(DIVING, 0.35, new Item.Properties()));
    public static final RegistryObject<Item> HAZMAT_GLOVES = registerGloves(HAZMAT, () -> new TooltipGlovesItem(HAZMAT, 0.35, Suppliers.memoize(() -> ThermalCore.ITEMS.get(ThermalIDs.ID_HAZMAT_CHESTPLATE)), new Item.Properties()));
    // Thermal Extra
    ...
    public static final RegistryObject<Item> DRAGONSTEEL_LIGHTNING_GLOVES = registerGloves(LIGHTNING_DRAGONSTEEL, 3.25);
            ...
            Stream.of("blue", "bronze", "deepblue", "green", "purple", "red", "teal")
                    .collect(Collectors.toUnmodifiableMap(
                            ...
                            color -> ITEMS.register(
                                    ...
                                    () -> new SeaSerpentScaleGlovesItem(SEA_SERPENT_SCALE, 1.1, color, new Item.Properties())
                            )
                    ));
