...
The Gloves For All addon implements ways to obtain gloves from selected other mods' materials. 
Gloves can be crafted or found the same way as their respective other armor pieces.
Any set bonuses now also require gloves to be equipped.
